...
palettes = Palette.create([
    ...
    {colors: ['#b9936c', '#dac292', '#e6e2d3', '#c4b7a6' ], tags: ['neutral', 'gray', 'creame', 'beige', 'tan']},
    {colors: ['#d5f4e6', '#80ced6', '#fefbd8', '#618685' ], tags: ['blue', 'teal', 'creame', 'calm']},
    {colors: ['#fefbd8', '#618685', '#36486b', '#4040a1' ], tags: ['blue', 'teal', 'creame', 'water']},
    ...
    {colors: ['#fbefcc', '#f9ccac', '#f4a688', '#e0876a' ], tags: ['light', 'peach', 'creame', 'monochromatic']},
    {colors: ['#fff2df', '#d9ad7c', '#a2836e', '#674d3c' ], tags: ['brown', 'tan', 'creame', 'beige']},
    ...
    {colors: ['#95B645', ' #FEB937 ', '#EFE1C6', '#FAF6EA', '#66666E' ], tags: ['gray', 'white', 'creame', 'yellow', 'green', 'kids']},
